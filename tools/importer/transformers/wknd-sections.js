 ...
 * Inserts an <hr> before each non-first section from page-templates.json and,
 * for any section with a `style`, a Section Metadata block. Selectors come from
 * the template's section definitions (DOM-verified during page analysis).
 *
 * Breaks are inserted in beforeTransform (while every section element still
 * exists) using a temporary marker; metadata is inserted in afterTransform,
